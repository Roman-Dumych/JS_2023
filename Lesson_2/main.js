...
// Масиви та об'єкти:
// Створити масив, наповнити його 10 елементами будь-якого типу, вивести кожен елемент в консоль.
let arr = [123, 234, 345, 456, 567, 678, 789, 890, 901, 999];
console.log(arr);
...
// Вивести в консоль пароль кожного користувача
let users = [
    {name: '', username: '', password: '123'},
    {name: '', username: '', password: '234'},
    {name: '', username: '', password: '345'},
    {name: '', username: '', password: '456'},
    {name: '', username: '', password: '567'},
    {name: '', username: '', password: '678'},
    {name: '', username: '', password: '789'},
    {name: '', username: '', password: '890'},
    {name: '', username: '', password: '901'},
    {name: '', username: '', password: '902'}
];
console.log(users[0].password);
console.log(users[1].password);
console.log(users[2].password);
